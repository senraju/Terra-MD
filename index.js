"use strict";
    ...
    var session = conf.session.replace(/TERRA_MD~/g,"");
    ...
    zk.ev.on('group-participants.update', async (group) => {
       ...
       console.log(group)
        ...
        try {
            ...
            ppgroup = 'https://i.imgur.com/GpxigDJ.jpeg';
        }
    ...
    ${metadata.desc}`;
                ...
                let msg = `Un memb(res) vient(nent) de quitter le groupe;\n`;
            ...
            for (let i = 0; i < crons.length; i++) {
              ...
              if (crons[i].mute_at != null) {
                ...
                cron.schedule(`${set[1]} ${set[0]} * * *`, async () => {
                  ...
                  zk.sendMessage(crons[i].group_id, { image : { url : './media/chrono.webp'} , caption: "Coucou c'est l'heure de fermer le groupe ; © igwetech " });
              ...
              if (crons[i].unmute_at != null) {
                ...
                cron.schedule(`${set[1]} ${set[0]} * * *`, async () => {
                  ...
                  zk.sendMessage(crons[i].group_id, { image : { url : './media/chrono.webp'} , caption: "Salam Aleicum ; C'est l'heure d'ouvrir le groupe " });
